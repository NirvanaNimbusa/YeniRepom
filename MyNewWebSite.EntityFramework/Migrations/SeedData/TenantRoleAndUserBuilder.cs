...
namespace MyNewWebSite.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        private readonly MyNewWebSiteDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(MyNewWebSiteDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new MyNewWebSiteAuthorizationProvider())
